...
document.getElementById('imgjinda03').addEventListener('click' , function(){
    forwardFunction(document.getElementById('imgjinda03').id);
} , false);

document.getElementById('imgjinda04').addEventListener('click' , function(){
    forwardFunction(document.getElementById('imgjinda04').id);
} , false);

document.getElementById('imgjinda05').addEventListener('click' , function(){
    forwardFunction(document.getElementById('imgjinda05').id);
} , false);

document.getElementById('imgjinda06').addEventListener('click' , function(){
    forwardFunction(document.getElementById('imgjinda06').id);
} , false);

document.getElementById('imgjinda07').addEventListener('click' , function(){
