...
window.onload = function initMap() {
    ...
    btn1.innerHTML = '<a href="index-multiple.html"><button type="button" id="c_btn" class="btn btn-primary btn-circle btn-xl"><i class="material-icons">camera</i></button></a>';
