...
url_list = open('_list.txt', 'r', encoding="utf-8")
count = 0
...
for i in range(count):
        ...
        try:
                ...
                name_restaurant = parse_content.find('')
                name_text = name_restaurant.text.strip("\n")
                info_restaurant = parse_content.find('', class_='')
                address_restaurant = parse_content.find('', class_='')
                reviews = parse_content.find_all('' , class_='')
                ...
                user_img = parse_img.find_all('', class_='')
                
                #Save all data to JSON file
                with open('C://Users//Supapitch//Desktop//data_restaurant//Web_Scraping//'+"_"+name_text+'.json', 'w', encoding="utf-8") as info:
                        info.write(str(data))
