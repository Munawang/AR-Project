...
for i in range(count):
    ...
    with open('C://Users//Supapitch//Desktop//data_restaurant//Place_API//'+place_id[0]+'_en'+'.json', 'w', encoding="utf-8") as info:
    	info.write(dataRaw_en)
    with open('C://Users//Supapitch//Desktop//data_restaurant//Place_API//'+place_id[0]+'_th'+'.json', 'w', encoding="utf-8") as info:
